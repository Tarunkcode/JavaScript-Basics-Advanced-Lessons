...
function rot13(str) {
  var givenArr = str.split("")

  var codesArr = []
  var valuesArr = []

  for (let i = 0; i < givenArr.length; i++) {
    var letter = givenArr[i]
    ...
    if (letter.match(/[A-Z]/)) {
      ...
      codesArr.push(letter.charCodeAt())
    }
  }

  for (let j = 0; j < codesArr.length; j++) {
    var alphabet = codesArr[j]
    valuesArr.push(String.fromCharCode(alphabet))
  }
  var result = valuesArr.join("")
